      ...
      <Layout>
        ...
        <section className="case-section">
          ...
          <p>
            ...
            found out that the problem didn't lie in that people didn't want to
            come back but the fact that they simply didn't know about the artist
            that was playing in Paard. The marketing side of Paard was outdated
            and hard to find.
          </p>
          ...
          <div className="split-wrapper">
            <div className="split-wrapper__column">
              <p>
                ...
                personalized Paard card a couple days later on your doorstep.
                This card is not only your ticket, for people that can't wait
                you can also scan the card and it will reveal the artist that
            ...
            <div className="split-wrapper__column case-highlight-block">
              ...
              <p>
                ...
                friends (or not) choose a genre and pick a date. We will
                surprise you with an artist your chosen genre. In that way, you
                can discover new artists and expand your Spotify list. As a
                cherry on top, we will send you your special invite card (also
                your entrance ticket) at home!
              </p>
            </div>
          </div>
        </section>
        <section className="case-section">
          <span className="subtitle">
            With a <span className="highlighted">personal touch</span>, we want
            to keep the people close. Let them{" "}
            <span className="highlighted">discover</span> new artists making
            sure they are having a{" "}
            <span className="highlighted">good time</span> with their friends.
          </span>
        </section>
        <section className="case-design case-section">
          ...
          <p>
            My task in this process was to design the one-pager and prototype.
            To do this It was necessary to create a good flow. To keep
            everything in the branding of Paard a style guide was also needed.
          </p>
          <div className="split-wrapper">
            <div className="split-wrapper__column">
        ...
        <section className="case-section">
          ...
          <p>
            ...
            Invision. It was a fine program to work with but I missed the
            ability to easily click through different paths without having to
            draw it out.
          </p>
