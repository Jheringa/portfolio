...
const PaardPage = () => {
  const data = useStaticQuery(graphql`
    query food {
      headervisual: file(relativePath: { eq: "Food-header.png" }) {
        childImageSharp {
          fluid(maxWidth: 1080) {
      ...
      <Layout>
        <ParallaxProvider>
          <section className="case-section" data>
            ...
            <Parallax y={[-15, 10]} tagOuter="figure">
              ...
              <p>
                ...
                Which colors are used in food advertisements and why? What are
                the rules in the kitchen about color use and would it be
                possible to play with colors whilst cooking a meal?
              </p>
              <p>
                As I'm a person that doesn't use recipes, there were a couple of
                recipe questions that I wanted answered before I started
                designing. What is important information needs to be in a
                recipe? Furthermore it was also important to know what the most
                common dislikes / allergies are the dangerous effects on people?
              </p>
            </Parallax>
          </section>
            ...
            {/* <div className="split-wrapper"> */}
              {/* <div className="split-wrapper__column"> */}
                <p>
                  ...
                  in general. My personal quest was to find a fun and easy way
                  to solve this. I had to take in consideration that most people
                  are not top chefs and that I needed to keep the recipes
                  simple. Another important note would be allergies, diets, and
                  dislikes. To keep people motivated and to let them try out new
          ...
          <section className="case-design case-section">
            ...
            <Parallax y={[-15, 10]} tagOuter="figure">
              <p>
                In the design proces, I took in encounter that certain colors
                are universally used to identify types of food, for example your
                cutting board color is telling you for what you should use it!
                Meat is red, bread is yellow and allergies is purple. Before
                making the final design and prototyping, I tested the design on
                my classmates and friend if they missed certain functions.
              </p>
            </Parallax>
            <div className="split-wrapper">
              <div className="split-wrapper__column">
